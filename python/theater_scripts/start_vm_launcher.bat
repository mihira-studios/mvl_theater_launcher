...
set "THEATER_EXECUTABLE=C:\dev\Engine\Binaries\Win64\UnrealEditor.exe"
set "THEATER_HOME=C:\dev\Engine\Binaries\Win64\UnrealEditor.exe"
set "THEATER_UPROJECT_TEMPLATE=C:\dev\Unreal Projects\MyProject\MyProject.uproject"
